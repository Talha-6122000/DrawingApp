 ...
 * @param attrs
 */
//So we are extending this class from a view to use view class properties
//Everything that you see on a screen is a view
//We have a constructor parameters for Drawing view class
//They receive context and attributes
class DrawingView(context: Context?, attrs:AttributeSet)
    :View(context,attrs) {
    //A variable of type Custompath(it's a class that we will declare and it will be of type inner
    // that can only be used inside this class so let's do this )
    private var mDrawPath :CustomPath?=null
    //Bitmap is used to handle pixels
   ...
   //now the init block to intialized all these variable that we have declared above
    init{
        setUpDrawing()
    }
    ...
    //This class will recive two constructor parameters named color and brushThickness
    //this class extend a built in class named Path that will draw path on the canvas
